      ...
      {!profile ? (
        ...
        <>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <div className="flex py-4 border-b border-gray-200"><span className="font-semibold text-gray-600 w-52">Total Patients</span><span className="text-gray-800 flex-1">{profile.totalPatients ?? 0}</span></div>
            ...
            <div className="flex py-4"><span className="font-semibold text-gray-600 w-52">Reviews</span><span className="text-gray-800 flex-1">{profile.reviews ?? 0}</span></div>
          </div>
        </>
      )}
    </DashboardLayout>
