  ...
  return (
    <DashboardLayout title="Nurse Profile">
      ...
      <div className="bg-white p-8 rounded-xl shadow-sm mb-5">
        ...
        <div className="flex py-4 border-b border-gray-200"><span className="font-semibold text-gray-600 w-52">Shift</span><span className="text-gray-800 flex-1">Morning</span></div>
        <div className="flex py-4 border-b border-gray-200"><span className="font-semibold text-gray-600 w-52">Assigned Ward</span><span className="text-gray-800 flex-1">Not assigned</span></div>
        <div className="flex py-4"><span className="font-semibold text-gray-600 w-52">Supervising Doctor</span><span className="text-gray-800 flex-1">Not assigned</span></div>
      </div>

      <div className="bg-white p-8 rounded-xl shadow-sm">
        <h2 className="text-gray-800 mb-5 text-2xl font-semibold">Statistics</h2>
        <div className="flex py-4 border-b border-gray-200"><span className="font-semibold text-gray-600 w-52">Assigned Patients</span><span className="text-gray-800 flex-1">0</span></div>
