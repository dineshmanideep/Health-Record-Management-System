        ...
        <div className="h-full flex flex-col overflow-y-auto custom-scrollbar">
          ...
          <div className="p-5 pb-3 border-b border-slate-100 dark:border-slate-800">
            ...
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white text-xs font-bold shadow-md">
